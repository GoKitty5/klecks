...
uniform vec2 tileOrigin; // pixel origin of this tile in full canvas
uniform vec2 tileSize; // pixel size of this tile
...
void main() {
    ...
    float val = 0.0;
    vec2 basePos = (texCoord * tileSize + tileOrigin) / scale - offset / scale + seedOffset;
